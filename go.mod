module github.com/pmenglund/colin
...
require (
	...
	github.com/pmenglund/codex-sdk-go v0.0.0-20260207194110-0c4886f6e0ee
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-20260222090600-424e9964d3a3 // indirect
